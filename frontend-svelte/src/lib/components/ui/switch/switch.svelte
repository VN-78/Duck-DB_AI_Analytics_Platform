...
>
	<SwitchPrimitive.Thumb
		...
		class="bg-background dark:data-unchecked:bg-foreground dark:data-checked:bg-primary-foreground flex items-center justify-center rounded-full shadow-sm not-dark:bg-clip-padding group-data-[size=default]/switch:h-7 group-data-[size=default]/switch:w-7 group-data-[size=sm]/switch:h-3 group-data-[size=sm]/switch:w-4 data-checked:translate-x-8 data-unchecked:translate-x-0 pointer-events-none block ring-0 transition-transform rtl:data-[state=checked]:translate-x-[calc(-100%)]"
	>
		{@render children?.()}
	</SwitchPrimitive.Thumb>
</SwitchPrimitive.Root>
